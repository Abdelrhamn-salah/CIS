...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg', help='The vgg model to use')

    parser.add_argument('--dogfile', type=str, default='dognames.txt', help='The path to a file containing a list of dog names.')
