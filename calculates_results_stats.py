...
def calculates_results_stats(results_dic):
    ...
    # Calculates % correct dogs based on the total number of images
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_images']) * 100.0

    # Calculates % correct breed of dog based on the total number of images
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / results_stats_dic['n_images']) * 100.0

    # Calculates % label matches (either a dog or not a dog)
    results_stats_dic['pct_label_matches'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0
